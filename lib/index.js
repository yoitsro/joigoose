...
internals.convert = joiObject => {
  if (joiObject === undefined && !Joi.isSchema(joiObject)) {
...
internals.mongooseValidateWrapper = (originalJoiSchema, value) => {
  ...
  if (joiSchema.validate(value, internals.joiGlobalOptions).error) {
    return false;
  }
